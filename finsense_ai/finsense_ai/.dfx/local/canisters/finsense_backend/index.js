...
import { idlFactory } from './finsense_backend.did.js';
export { idlFactory } from './finsense_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FINSENSE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./finsense_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the finsense_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./finsense_backend.did.js")._SERVICE>}
 */
export const finsense_backend = createActor(canisterId);
