...
import { idlFactory } from './finsense_frontend.did.js';
export { idlFactory } from './finsense_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FINSENSE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./finsense_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the finsense_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./finsense_frontend.did.js")._SERVICE>}
 */
export const finsense_frontend = createActor(canisterId);
